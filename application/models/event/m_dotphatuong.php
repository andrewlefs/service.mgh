...
class m_dotphatuong extends CI_Model {
    private $db_cache, $db;
    ...
    function check_received_gifts_with_GiftId($mobo_service_id, $server_id, $gift_id, $tournament){
        ...
        $this->db->from("event_dotphatuong_history");
    ...
    public function update_exchange_history($id, $send_item_data, $send_item_result, $status, $gift_id) {
        ...
        $this->db->update("event_dotphatuong_history");      
    ...
    function log($char_id, $server_id, $char_name, $mobo_service_id, $exchange_date, $mobo_id, $send_item_result){
        ...
        $this->db->insert('event_dotphatuong_history', $data);
    }
    
    //History
    public function get_exchange_history($server_id, $mobo_service_id, $tournament_id) {
        $query = "SELECT eteh.id, eteh.exchange_date, etr.item_name, etr.item_quantity";
        $query .= " FROM event_dotphatuong_history eteh";
        $query .= " LEFT JOIN event_dotphatuong_gift etr ON (eteh.gift_id = etr.id)";

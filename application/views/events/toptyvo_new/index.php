...
<head>
    ...
    <link rel="stylesheet" href="/mgh2/assets_dev/events/toptyvo/css/style.css">
    <script type="text/javascript" src="/mgh2/assets_dev/events/toptyvo/scripts/jquery.min.js"></script>
    <script type="text/javascript" src="/mgh2/assets_dev/events/toptyvo/scripts/jquery.blockUI.js"></script>
    <script src="/mgh2/assets_dev/events/toptyvo/scripts/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
    <script src="/mgh2/assets_dev/events/toptyvo/scripts/jquery.spritely.js" type="text/javascript"></script>
    <script src="/mgh2/assets_dev/events/toptyvo/scripts/play.js" type="text/javascript"></script>
    <script src="/mgh2/assets_dev/events/toptyvo/scripts/main.js"></script>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#yes_pet').click(function () {
                ...
                if (action == "gift") {
                    ...
                    $.ajax({
                        method: "GET",
                        url: "/mgh2/event/toptyvo_new/gift_exchange/?id=" + id,
                ...
                if (action == "gifttop") {
                    ...
                    $.ajax({
                        method: "GET",
                        url: "/mgh2/event/toptyvo_new/gift_top_exchange/?id=" + id,
                        contentType: 'application/json; charset=utf-8',
                        success: function (data) {
                            json_data = $.parseJSON(data);
                            if (json_data.code != null && json_data.code != "0") {
                ...
                if (action == "gifttoppremier") {
                    ...
                    $.ajax({
                        method: "GET",
                        url: "/mgh2/event/toptyvo_new/gift_top_exchange_premiership/?id=" + id,
                        contentType: 'application/json; charset=utf-8',
                        success: function (data) {
                            json_data = $.parseJSON(data);
                            if (json_data.code != null && json_data.code != "0") {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                method: "GET",
                url: "/mgh2/event/toptyvo_new/tournament_list_ex",
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    ...
                    //Load Touenament details
                    //tournament_detais($("#tournament_id").val());
                },
                error: function (data) {
        ...
        function thamgia() {
            ...
            $(".loading").show();
            $.ajax({
                url: "/mgh2/event/toptyvo_new/thamgia?id=" + tournament_id,
                type: "GET",
                contentType: 'application/json; charset=utf-8'
            })
                .done(function (data) {
        ...
        function get_top() {
            ...
            if (tournament_id >= 12) {
                $.ajax({
                    url: "/mgh2/event/toptyvo_new/get_top?id=" + tournament_id + "&server_id=" + server_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_premiership() {
            ...
            if (tournament_id >= 12) {
                $.ajax({
                    url: "/mgh2/event/toptyvo_new/get_top_premiership?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_all_server() {
            ...
            if (tournament_id >= 14) {
                $.ajax({
                    url: "/mgh2/event/toptyvo_new/get_top_allserver?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_arena() {
            ...
            if (tournament_id >= 12) {
                $.ajax({
                    url: "/mgh2/event/toptyvo_new/get_top_arena?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_battle() {
            ...
            if (tournament_id >= 12) {
                $.ajax({
                    url: "/mgh2/event/toptyvo_new/get_top_battle?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function lichsu() {
            ...
            $.ajax({
                url: "/mgh2/event/toptyvo_new/get_exchange_history?id=" + tournament_id,
                type: "GET",
                contentType: 'application/json; charset=utf-8'
            })
                .done(function (data) {
        ...
        function thele() {
            $(".loading").show();
            $.ajax({
                url: "/mgh2/event/getnews/content_news?id=5635",
                type: "GET",
                contentType: 'application/json; charset=utf-8'
            })
                .done(function (data) {
...
<body>
        ...
        <div class="wrap">
            <div class="header">
                ...
                <a href="javascript:void(0);" rel="get-top" class="menu-item menu-item-item2"
                    onclick="showcontent(this);get_top_arena();">Top</a>             
            </div>
            <div id="content">
                <div class="children">
                    <div style="margin: 0 auto; font-size: 15px">
                        ...
                        <div id="get-top" class="content" style="display: none; text-align: center;">
                            <a href="javascript:void(0);" class="tab-button tab-button1 active" onclick="get_top_arena();">Đấu Trường</a>  <a href="javascript:void(0);" class="tab-button tab-button2" onclick="get_top_battle();">Lực Chiến</a>
    ...
    <div class="loading">
        <img src="/mgh2/assets_dev/events/toptyvo/images/loading.gif" />
    </div>

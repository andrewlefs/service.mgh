...
<div class="h-content" style="background: url('http://service.mgh.mobo.vn/assets/events/dautruong/images/gate_bg2.jpg');">
    <div class="modaldoiqua">
        ...
        <div style="font-size: 20px; font-weight: bold; margin-top: 10px; text-align: center;">Đổi Thẻ</div>        
        <div class="m-content nap-the">            
            <table style="margin: 0 auto; width: 85%;">
                ...
                <tr>                   
                    <td class="input" colspan="2" style="text-align: center"><a id="exchange_card" class="pet-button" type="button" value="Đồng ý" onclick="exchange_card()">Đổi Thẻ</a></td>
                </tr>
            </table>

...
<head>
    ...
    <link rel="stylesheet" href="/mgh2/assets_dev/events/toploidai/css/style.css">
    <script type="text/javascript" src="/mgh2/assets_dev/events/toploidai/scripts/jquery.min.js"></script>
    <script type="text/javascript" src="/mgh2/assets_dev/events/toploidai/scripts/jquery.blockUI.js"></script>
    <script src="/mgh2/assets_dev/events/toploidai/scripts/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
    <script src="/mgh2/assets_dev/events/toploidai/scripts/jquery.spritely.js" type="text/javascript"></script>
    <script src="/mgh2/assets_dev/events/toploidai/scripts/play.js" type="text/javascript"></script>
    <script src="/mgh2/assets_dev/events/toploidai/scripts/main.js"></script>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#yes_pet').click(function () {
                ...
                if (action == "gift") {
                    ...
                    $.ajax({
                        method: "GET",
                        url: "/mgh2/event/toploidai/gift_exchange/?id=" + id,
                ...
                if (action == "gifttop") {
                    ...
                    $.ajax({
                        method: "GET",
                        url: "/mgh2/event/toploidai/gift_top_exchange/?id=" + id,
                        contentType: 'application/json; charset=utf-8',
                        success: function (data) {
                            json_data = $.parseJSON(data);
                            if (json_data.code != null && json_data.code != "0") {
                ...
                if (action == "gifttoppremier") {
                    ...
                    $.ajax({
                        method: "GET",
                        url: "/mgh2/event/toploidai/gift_top_exchange_premiership/?id=" + id,
                        contentType: 'application/json; charset=utf-8',
                        success: function (data) {
                            json_data = $.parseJSON(data);
                            if (json_data.code != null && json_data.code != "0") {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                method: "GET",
                url: "/mgh2/event/toploidai/tournament_list_ex",
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
        ...
        function thamgia() {
            ...
            $(".loading").show();
            $.ajax({
                url: "/mgh2/event/toploidai/thamgia?id=" + tournament_id,
                type: "GET",
                contentType: 'application/json; charset=utf-8'
            })
                .done(function (data) {
        ...
        function get_top() {
            ...
            if (tournament_id >= 12) {
                $.ajax({
                    url: "/mgh2/event/toploidai/get_top?id=" + tournament_id + "&server_id=" + server_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_premiership() {
            ...
            if (tournament_id >= 12) {
                $.ajax({
                    url: "/mgh2/event/toploidai/get_top_premiership?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_all_server() {
            ...
            if (tournament_id >= 14) {
                $.ajax({
                    url: "/mgh2/event/toploidai/get_top_allserver?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_arena() {
            ...
            var tournament_id = $("#tournament_id_3").val();           
             ...
             $.ajax({
                    url: "/mgh2/event/toploidai/get_top_arena?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function get_top_battle() {
            ...
            if (tournament_id >= 12) {
                $.ajax({
                    url: "/mgh2/event/toploidai/get_top_battle?id=" + tournament_id,
                    type: "GET",
                    contentType: 'application/json; charset=utf-8'
                })
                    .done(function (data) {
        ...
        function lichsu() {
            ...
            $.ajax({
                url: "/mgh2/event/toploidai/get_exchange_history?id=" + tournament_id,
                type: "GET",
                contentType: 'application/json; charset=utf-8'
            })
                .done(function (data) {
        ...
        function thele() {
            $(".loading").show();
            $.ajax({
                url: "/mgh2/event/getnews/content_news?id=5793",
                type: "GET",
                contentType: 'application/json; charset=utf-8'
            })
                .done(function (data) {
...
<body>
    ...
    <div class="loading">
        <img src="/mgh2/assets_dev/events/toploidai/images/loading.gif" />
    </div>

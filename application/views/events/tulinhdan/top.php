...
<div class="h-content">
    ...
    <div id="tournament" style="margin: auto; width: 288px; font-size: 13px;">
        <div style="margin-top: 10px; text-align: left;">
            *Điểm của bạn: <span style="font-weight: bold; color: #1649E8;"><?php echo $user_point; ?></span>, Hạng: <span style="font-weight: bold; color: #1649E8;"><?php echo $user_rank; ?></span>
        </div>
        <?php
        if($tournament)
    ...
    <div class="h-list" style="overflow-y: scroll; overflow-x: scroll; margin-top: 10px; height: 270px;">
        <table id="customers" class="table-role" style="margin-top: 0 !important;">
            ...
            <tr>
                ...
                <td><?php echo $value["user_point"]; ?></td>             
            </tr>
            <?php } ?>
        </table>
    </div>

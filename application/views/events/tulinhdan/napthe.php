<div class="h-content">
    ...
    <div id="exchange_top" class="content" style="text-align: center; margin-top: 10px">
                <table style="width: 288px; margin: auto; font-size: 12px; margin-bottom: 20px;">
                    <tr>
                        <td style="text-align: left;">*Ngân Lượng của bạn: <span id="user_point_2" style="color: red; font-weight: bold;"><?php echo $this->data['user_point']; ?></span></td>
    ...
    <div class="h-list" style="border: 3px solid #F79646;padding-bottom: 10px;">        
        <div style="font-size: 20px; font-weight: bold; margin-top: 10px; text-align: center;">Nạp Thẻ Đổi Ngân Lượng</div>
        ...
        <div class="m-content nap-the">            
            <table style="margin: 0 auto">
                ...
                <tr>
                    ...
                    <td class="input"><a id="agree_pay" class="pet-button" type="button" value="Đồng ý" onclick="charging()">Nạp Thẻ</a></td>
                </tr>
            </table>
...
<!--    <div style="margin-top: 5px; text-align: center; margin-bottom: 10px">
            <a href="javascript:void(0);" class="big-button" onclick="exchange_gift();">Dùng Ngân Lượng đổi quà</a>
        </div>-->

        ...
        <div class="container">
            <div class="row">
                <div id="main-menu-bt">
                    ...
                    ?>
                    <ul>
                        <li class="col-xs-3"><a href="/mathan/social/temp?<?php echo http_build_query($params); ?>">Sự kiện</a></li>                        
                        <li class="col-xs-9"><a>Nhân vật: <?php echo $user->character_name ?>, Máy chủ: <?php $svname = $controler->parse_server_name(146, $user->server_id); echo str_replace("[". $user->server_id . "]", "", $svname["server_name"]);  ?></a></li>                    
                    </ul>
                </div>      
                <div class="col-xs-12">                    

                ...
                <table style="width: 288px; margin: auto; font-size: 12px;">
                    <tr>
                        <td style="text-align: center;">*Điểm Giang Hồ: <span id="user_point_2" style="color: red; font-weight: bold;"><?php echo $user_point; ?></span>
                           - <a href="javascript:void(0);" rel="nap-the" class="point-button" onclick="showcontent(this);transfer_np();">Chuyển Điểm Giang Hồ</a>
                            <!--<a href="javascript:void(0);" rel="lich-su" class="point-button2" onclick="showcontent(this);lichsu();">Lịch sử</a>-->
                        </td>
    ...
    <div style="margin-top: 5px; padding: 5px;">
        ...
        <table style="width: 100%; margin-top: 5px;border: 1px solid #E46C0A;">
            ...
            <tr>
                ...
                <td>
                    <?php if($this->data["user_vip_point"] < $value["gift_vip_point"]) {?>

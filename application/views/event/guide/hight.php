    ...
    <div id="thele">    
        ...
        foreach ($rows as $key => $value) {
            ...
            <div class="row-menu right-arrow" style="text-align: center; background:none;height: 67px; <?php echo (($row % 2) == 0) ? "" : "" ?> ">
                <div class="media">
                    <a href='/giangma/event/guide/view?ids=<?php echo $value["original_id"] ?>&<?php echo http_build_query($_GET) ?>'><img class="thumb" src="http://fantasy.mobo.vn<?php echo $value["feature_image"] ?>"><?php echo $value["title"] ?></a>
                </div>                
                <div class="media-body"> 
                    <a class="title" href="/giangma/event/guide/view?ids=<?php echo $value["original_id"] ?>&<?php echo http_build_query($_GET) ?>"><?php echo $value["title"] ?></a><br>

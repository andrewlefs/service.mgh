<?php
class tooltoploidai extends CI_Controller {
    function __construct() {
        parent::__construct();

        $this->load->model('cms/m_tooltoploidai');
    ...
    function add_tournament(){
        ...
        $data = $this->m_tooltoploidai->add_tournament($params);
    ...
    function edit_tournament(){
        ...
        $data = $this->m_tooltoploidai->edit_tournament($params);
    ...
    function edit_tournament_details(){
        ...
        $data = $this->m_tooltoploidai->edit_tournament_details($params);
    ...
    public function tournament_list(){
        $data = $this->m_tooltoploidai->tournament_list();
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    public function tournament_get_by_id(){
        ...
        $data = $this->m_tooltoploidai->tournament_get_by_id($id);
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    public function tournament_list_name_id(){
        $data = $this->m_tooltoploidai->tournament_list_name_id();
    ...
    function add_reward(){
        ...
        $data = $this->m_tooltoploidai->add_reward($params);
    ...
    function load_reward(){
        ...
        $data = $this->m_tooltoploidai->load_reward($tournament_id);
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    function load_reward_details() {
        ...
        $data = $this->m_tooltoploidai->load_reward_details($id);
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    function edit_reward_details(){
        ...
        $data = $this->m_tooltoploidai->edit_reward_details($params);
    ...
    function edit_reward_name(){
        ...
        $data = $this->m_tooltoploidai->edit_reward_name($params);
    ...
    function add_reward_top(){
        ...
        $data = $this->m_tooltoploidai->add_reward_top($params);
    ...
    function load_reward_top(){
        ...
        $data = $this->m_tooltoploidai->load_reward_top($tournament_id);
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    function load_reward_details_top() {
        ...
        $data = $this->m_tooltoploidai->load_reward_details_top($id);
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    function edit_reward_details_top(){
        ...
        $data = $this->m_tooltoploidai->edit_reward_details_top($params);
    ...
    function edit_reward_name_top(){
        ...
        $data = $this->m_tooltoploidai->edit_reward_name_top($params);
    ...
    function add_reward_premiership(){
        ...
        $data = $this->m_tooltoploidai->add_reward_premiership($params);
    ...
    function load_reward_premiership(){
        ...
        $data = $this->m_tooltoploidai->load_reward_premiership($tournament_id);
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    function load_reward_details_premiership() {
        ...
        $data = $this->m_tooltoploidai->load_reward_details_premiership($id);
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    function edit_reward_details_premiership(){
        ...
        $data = $this->m_tooltoploidai->edit_reward_details_premiership($params);
    ...
    function edit_reward_name_premiership(){
        ...
        $data = $this->m_tooltoploidai->edit_reward_name_premiership($params);
    ...
    function get_exchange_history()
    {
        ...
        if($type == "1"){
        $data = $this->m_tooltoploidai->get_exchange_history($tournament_id, $startdate, $enddate);
        }
        if($type == "2"){
        $data = $this->m_tooltoploidai->get_exchange_history_top($tournament_id, $startdate, $enddate);
        }
        if($type == "3"){
        $data = $this->m_tooltoploidai->get_exchange_history_premiership($tournament_id, $startdate, $enddate);
        }
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
    ...
    {
        $data = $this->m_tooltoploidai->get_exchange_history_top();
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            
    ...
    {
        $data = $this->m_tooltoploidai->get_exchange_history_premiership();
        $R=$data;
        if(isset($_GET['callback'])){
            echo $_GET['callback']."(".json_encode($R).")";
        }else{            

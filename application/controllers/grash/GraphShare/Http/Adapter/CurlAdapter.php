...
namespace GraphShare\Http\Adapter;

use GraphShare\Http\Adapter\Curl\AbstractCurl;
use GraphShare\Http\Adapter\Curl\Curl;
use GraphShare\Http\Adapter\Curl\CurlInterface;

...
class Captcha {
    ...
    public function __construct() {
        $this->fontPath = BASEPATH . '../public' . DIRECTORY_SEPARATOR . 'fonts' . DIRECTORY_SEPARATOR;
    ...
    protected function WriteText($text) {
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            $fontsize = '150'; //rand($fontcfg['minSize'], $fontcfg['maxSize'])*$this->scale*(1+(($this->maxWordLength-strlen($text))*1.09));

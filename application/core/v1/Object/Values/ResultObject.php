...
namespace MigEvents\Object\Values;

use MigEvents\Object\AbstractObject;
use GraphApi\Http\Client\ClientInterface;
use MigEvents\Tripledes;
use MigEvents\Logger\LoggerInterface;
use MigEvents\Logger\NullLogger;
...
class ResultObject extends AbstractObject {
    ...
    public function OutOfEncryptResponse() {
        ...
        echo Tripledes::encrypt($this->export(), $this->getHashKey());
        die;
    }

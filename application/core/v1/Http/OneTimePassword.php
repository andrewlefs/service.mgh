...
abstract class OneTimePassword {
    ...
    static public function getCode($scretkey = null, $timeSlice = null) {
        ...
        if (empty($scretkey)) {
            ...
            $secretkey = OneTimePassword::_base32Decode($scretkey);
        }
        ...
        $modulo = pow(10, OneTimePassword::DefaultCodeLength);
        return str_pad($value % $modulo, OneTimePassword::DefaultCodeLength, '0', STR_PAD_LEFT);
    }
